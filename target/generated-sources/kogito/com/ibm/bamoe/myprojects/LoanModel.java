...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "loan", name = "Loan", hidden = false)
public class LoanModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<LoanModelOutput> {
    ...
    @Override()
    public LoanModelOutput toModel() {
        LoanModelOutput result = new LoanModelOutput();
        result.setId(getId());
