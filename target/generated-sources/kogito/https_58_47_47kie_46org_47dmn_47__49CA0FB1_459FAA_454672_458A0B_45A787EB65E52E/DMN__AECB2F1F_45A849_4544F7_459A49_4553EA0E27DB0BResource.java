 ...
 * under the License.
 */
package https_58_47_47kie_46org_47dmn_47__49CA0FB1_459FAA_454672_458A0B_45A787EB65E52E;
...
@Path("/DMN_AECB2F1F-A849-44F7-9A49-53EA0E27DB0B")
public class DMN__AECB2F1F_45A849_4544F7_459A49_4553EA0E27DB0BResource {
    ...
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/InterestEvaluator.json#/definitions/InputSet")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/InterestEvaluator.json#/definitions/OutputSet")), description = "DMN output")
    public Response dmn(java.util.Map<String, Object> variables) {
        long startTime = System.nanoTime();
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kie.org/dmn/_49CA0FB1-9FAA-4672-8A0B-A787EB65E52E", "DMN_AECB2F1F-A849-44F7-9A49-53EA0E27DB0B");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kie.org/dmn/_49CA0FB1-9FAA-4672-8A0B-A787EB65E52E", "DMN_AECB2F1F-A849-44F7-9A49-53EA0E27DB0B", decisionResult);
        long endTime = System.nanoTime();
        systemMetricsCollectorProvider.get().registerElapsedTimeSampleMetrics("DMN_AECB2F1F-A849-44F7-9A49-53EA0E27DB0B", endTime - startTime);
    ...
    public String dmn() throws java.io.IOException {
        try (InputStream is = this.getClass().getResourceAsStream(CodegenStringUtil.escapeIdentifier("DMN_AECB2F1F-A849-44F7-9A49-53EA0E27DB0B") + ".dmn_nologic")) {
    ...
    private ResponseBuilder buildFailedEvaluationResponse(KogitoDMNResult result) {
        systemMetricsCollectorProvider.get().registerException("DMN_AECB2F1F-A849-44F7-9A49-53EA0E27DB0B", result.getMessages().stream().filter(x -> org.kie.dmn.api.core.DMNMessage.Severity.ERROR.equals(x.getSeverity())).map(x -> x.getMessage()).collect(Collectors.joining(",")));
